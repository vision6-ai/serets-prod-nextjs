...
// Add a type for props that include locale
type WithLocale = {
	locale?: Locale;
};
...
const SelectTrigger = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & WithLocale
...
const SelectContent = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & WithLocale
>(({ className, children, position = 'popper', locale, ...props }, ref) => {
	const isRtl = isRtlLocale(locale);
...
const SelectLabel = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof SelectPrimitive.Label> & WithLocale
...
const SelectItem = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & WithLocale
>(({ className, children, locale, ...props }, ref) => {
	const isRtl = isRtlLocale(locale);
