    ...
    <div className="container relative mx-auto px-4 py-8 z-10">
      <SEO
        ...
        schema={{
          ...
          "@type": "Movie",
          "name": movie.title,
          "alternateName": movie.hebrew_title,
          ...
          "actor": cast.map(actor => ({
            "@type": "Person",
            "name": actor.name,
            "alternateName": actor.hebrew_name
          }))
        }}
      />
          ...
          <div className="w-full md:w-1/3">
            {movie.poster_url ? (
              <img
                ...
                onError={(e) => {
                  ...
                  img.src = `https://placehold.co/600x900/374151/FFFFFF?text=${encodeURIComponent(movie.title)}`;
                  img.onerror = null;
                }}
              />
            ) : (
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="md:hidden">
                ...
                {movie.synopsis && (
                  <p className="text-lg leading-relaxed mb-6">{movie.synopsis}</p>
                )}
              </div>
                ...
                {safeSimilarMovies.length > 0 && (
                  <div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {safeSimilarMovies.map((movie) => (
                        <Card key={movie.id} className="hover-card">
