/*
  # Israeli Movie Hub Database Schema

  1. New Tables
    - `movies`: Core movie information
    - `actors`: Actor profiles and details
    ...
    - `seo_meta`: SEO metadata for various content types
  ...
  2. Security
    ...
    - Protected write access for user-specific tables
*/
