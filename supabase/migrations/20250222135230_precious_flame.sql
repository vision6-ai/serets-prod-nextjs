/*
  ...
  1. Drop and recreate blog tables to ensure clean state
  2. Add proper indexes and constraints
  3. Add sample content with featured images from movie posters
*/
...
INSERT INTO blog_categories (name, slug, description) VALUES
  ...
  ('Interviews', 'interviews', 'Conversations with filmmakers and actors');
...
-- Add sample blog posts with featured images from movie posters
...
(
  ...
  'https://media.themoviedb.org/t/p/w185/qZdFpkJJYxK2xP3jaecyZIzOMR4.jpg',
...
(
  ...
  'https://media.themoviedb.org/t/p/w185/kQwR6v827TZGNVgWIgfXbr1g859.jpg',
...
(
  ...
  'https://media.themoviedb.org/t/p/w185/iKyD2hbKYVbDGFYoReV3v8JvZe3.jpg',
  'https://media.themoviedb.org/t/p/w1920_and_h800_multi_faces/iKyD2hbKYVbDGFYoReV3v8JvZe3.jpg',
  'published',
  NOW() - INTERVAL '5 days'
),
(
  'Behind the Scenes: Making of Waltz with Bashir',
  'behind-the-scenes-waltz-with-bashir',
  'An exclusive look at the groundbreaking animation process and storytelling techniques used in Waltz with Bashir.',
  '{"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "The innovative animation techniques and powerful storytelling of Waltz with Bashir revolutionized documentary filmmaking..."}]}]}',
  'Rachel Stern',
  'Documentary filmmaker and animation expert',
  'https://media.themoviedb.org/t/p/w185/uzUPwWSxgQqDz3kuYIYhxGrHEtH.jpg',
  'https://media.themoviedb.org/t/p/w1920_and_h800_multi_faces/uzUPwWSxgQqDz3kuYIYhxGrHEtH.jpg',
  'published',
  NOW() - INTERVAL '7 days'
);
...
SELECT p.id, c.id
FROM blog_posts p, blog_categories c
WHERE p.slug = 'behind-the-scenes-waltz-with-bashir' AND c.slug = 'features';
...
SELECT p.id, t.id
FROM blog_posts p, blog_tags t
WHERE p.slug = 'behind-the-scenes-waltz-with-bashir' AND t.slug = 'behind-the-scenes';