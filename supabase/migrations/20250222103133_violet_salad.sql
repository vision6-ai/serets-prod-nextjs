/*
  # Fix awards schema and relationships

  1. Changes
    - Drop and recreate awards tables with proper structure
...
DROP TABLE IF EXISTS actor_awards CASCADE;
...
-- Create movie_awards junction table with explicit reference
