/*
  ...
  1. New Tables
    ...
    - seo_meta
    - awards
    - actor_awards (junction)
    - movie_awards (junction)
  ...
  3. Security
    ...
    - Public read access
    - Authenticated user access for interactive features
*/
...
CREATE POLICY "Allow public read access on seo_meta" ON seo_meta FOR SELECT TO public USING (true);
